        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          ...
          <div className="grid grid-cols-3 gap-3 place-items-center">
            {ourCertifications.map((award, i) => (
              <ScrollReveal key={award.title} delay={i * 80}>
                <div className="flex flex-col items-center text-center group bg-background w-32 overflow-hidden rounded-lg p-3 border border-primary/20 hover:border-primary/60 transition-all duration-500 hover:shadow-[0_0_20px_-5px_hsl(var(--gold)/0.4)]">
                  <div className="w-full aspect-square rounded-xl overflow-hidden border border-primary/20 group-hover:border-primary/60 transition-all duration-500 group-hover:shadow-[0_0_20px_-5px_hsl(var(--gold)/0.4)]">
                    <img
                      src={award.image}
                      alt={award.title}
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
